...
export const SET_JAB_LEFT_STATE_PATTERN_ONE = 'SET_JAB_LEFT_STATE_PATTERN_ONE';
export const SET_CROSS_LEFT_STATE_PATTERN_ONE = 'SET_CROSS_LEFT_STATE_PATTERN_ONE';
export const SET_UPPERCUT_LEFT_STATE_PATTERN_ONE = 'SET_UPPERCUT_LEFT_STATE_PATTERN_ONE';
