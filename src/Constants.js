...
export const SET_BODY_JAB_LEFT_STATE = 'SET_BODY_JAB_LEFT_STATE';
export const SET_STILL_RIGHT_STATE = 'SET_STILL_RIGHT_STATE';
export const SET_JAB_RIGHT_STATE = 'SET_JAB_RIGHT_STATE';
export const SET_JAB_RIGHT_SECOND_STATE = 'SET_JAB_RIGHT_SECOND_STATE';
export const SET_CROSS_RIGHT_STATE = 'SET_CROSS_RIGHT_STATE';
export const SET_UPPERCUT_RIGHT_STATE = 'SET_UPPERCUT_RIGHT_STATE';
export const SET_BODY_JAB_RIGHT_STATE = 'SET_BODY_JAB_RIGHT_STATE';
...
export const PATTERN_ONE = [
  SET_STILL_LEFT_STATE,
  SET_UPPERCUT_LEFT_STATE,
  SET_UPPERCUT_RIGHT_STATE,
  SET_STILL_LEFT_STATE,
  SET_CROSS_RIGHT_STATE,
  SET_CROSS_LEFT_STATE
];

export const PATTERN_TWO = [
  SET_BODY_JAB_LEFT_STATE,
  SET_BODY_JAB_RIGHT_STATE,
  SET_BODY_JAB_LEFT_STATE,
  SET_BODY_JAB_RIGHT_STATE,
  SET_BODY_JAB_LEFT_STATE,
  SET_BODY_JAB_RIGHT_STATE,
